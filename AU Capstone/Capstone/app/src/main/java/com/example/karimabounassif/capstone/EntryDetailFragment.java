...
public class EntryDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myDbAdapter helper = new myDbAdapter(this.getContext());                    //Retrieving user info from db
        String[] check = helper.checkUserPW(user.getUsername(), user.getPassword());
        user = new User(check[0],check[1],check[2],check[3],check[4]);
